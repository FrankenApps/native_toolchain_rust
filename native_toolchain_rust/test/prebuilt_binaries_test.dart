    ...
    test('resolveDownloadUrl substitutes all placeholders', () {
      ...
      expect(
        ...
        Uri.parse(
          ...
          '/aarch64-apple-darwin-libmy_crate.dylib',
        ),
      );
    });
  ...
  group('PrebuiltBinaryFetcher', () {
    ...
    test(
      ...
      () async {
        ...
        ).thenReturn('https://example.com/{lib-name}');
        when(
          () => mockPubspecVersionParser.parseVersion(any()),
        ).thenReturn('1.2.3');
        when(
        ...
        verify(
          () => mockDownloadUrlResolver.resolveDownloadUrl(
            urlTemplate: 'https://example.com/{lib-name}',
            templateValues: {
              'version': '1.2.3',
              'target': 'x86_64-unknown-linux-gnu',
              'lib-name': 'libmy_crate.a',
            },
          ),
        ).called(1);
      },
